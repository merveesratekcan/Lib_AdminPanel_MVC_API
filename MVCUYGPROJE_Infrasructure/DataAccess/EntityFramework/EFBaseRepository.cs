...
namespace MVCUYGPROJE_Infrastructure.DataAccess.EntityFramework;

public class EFBaseRepository<TEntity> : IAsyncDeletableRepository<TEntity>, IAsyncFindableRepository<TEntity>, IAsyncInsertable<TEntity>, IAsyncOrderableRepository<TEntity>, IAsyncQueryableRepository<TEntity>, IAsyncUpdatableRepository<TEntity>, IAsyncRepository, IAsyncTransactionRepository, IRepository where TEntity : BaseEntity
{
    ...
    {
        var values = _table.Where(x => x.Status != MVCUYGPROJE_Domain.Enums.Status.Deleted);
